...
class CountriesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $countries = array(
            ...
            array('id' => 247, 'code' => 'SA', 'name' => "South America", 'phonecode' => 000),
            array('id' => 248, 'code' => 'NA', 'name' => "North America", 'phonecode' => 000),
            array('id' => 249, 'code' => 'EA', 'name' => "Eastern Europe", 'phonecode' => 000),
            array('id' => 250, 'code' => 'EU', 'name' => "Europe", 'phonecode' => 000),
            array('id' => 251, 'code' => 'EAS', 'name' => "East Asia", 'phonecode' => 000),
            array('id' => 252, 'code' => 'SAS', 'name' => "South Asia", 'phonecode' => 000),
            array('id' => 253, 'code' => 'MEA', 'name' => "Middle East", 'phonecode' => 000),
            array('id' => 254, 'code' => 'NAF', 'name' => "North Africa", 'phonecode' => 000),
            array('id' => 255, 'code' => 'G', 'name' => "Global (Any Country)", 'phonecode' => 000),
        );
