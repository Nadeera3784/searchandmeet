...
@section('content')
    <div class="w-full h-full relative inline-flex flex-col py-24 px-24">
        <div class="flex justify-between items-center w-full py-5 px-9 bg-white z-10">
            <p class="text-2xl font-bold mr-8 text-primary">Privacy Policy</p>
        </div>
        <div class="overflow-y-auto w-full h-full max-h-full mb-5 relative z-0 px-9" style="">
            <div class="" style="height:max-content;">
                <p style="text-align: left;">
                   &nbsp;Your privacy is important to us. It is Search Meetings Inc's policy to respect your privacy regarding any information we may collect from you across our website, <a class="text-indigo-500 font-bold" href="https://searchmeeting.com/">https://searchmeeting.com/</a>, and other sites we own and operate.
                </p>
                <h3 class="font-bold text-lg mt-4 mb-1" style="text-align: left;">
                ...
                <ul class="list-disc pl-5">
                    ...
                    <li style="text-align: left;">Social media profiles</li>
                    <li style="text-align: left;">Phone/mobile number</li>
                    <li style="text-align: left;">Work address</li>
                    <li style="text-align: left;">Payment information</li>
                    <li style="text-align: left;">Business preferences</li>
                </ul>
                <h3 class="font-bold text-lg mt-4 mb-1">
                    <strong>2. Legal bases for processing</strong>
                </h3>
                <p>
                ...
                <h3 class="font-bold text-lg mt-4 mb-1">
                    <strong>3. Collection and use of information</strong>
                </h3>
                <p>
                ...
                <h3 class="font-bold text-lg mt-4 mb-1">
                    <strong>4. Disclosure of personal information to third parties</strong>
                </h3>
                <p>
                ...
                <h3 class="font-bold text-lg mt-4 mb-1">
                    <strong>6. Your rights and controlling your personal information</strong>
                </h3>
                <p class="mt-2">
                ...
                <h3 class="font-bold text-lg mt-4 mb-1">
                    <strong>8. Business transfers</strong>
                </h3>
                <p>
                    If we or our assets are acquired, or in the unlikely event that we go out of business or enter bankruptcy, we would include data among the assets transferred to any parties who acquire us. You acknowledge that such transfers may occur, and that any parties who acquire us may continue to use your personal information according to this policy.
                </p>
                <h3 class="font-bold text-lg mt-4 mb-1">
                    <strong>9. Limits of our policy</strong>
                </h3>
                <p>
                ...
                <br>
                <p>
                    Search Meetings Inc Data Controller<br>Rasika Kulasekara<br><a href="mailto:info@searchmeetings.com">info@searchmeetings.com</a>
                </p>
                <br>
                <br>
                <p>This policy is effective as of 1st May 2021.</p>
            </div>
        </div>
    </div>
@endsection
