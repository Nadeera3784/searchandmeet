...
@section('content')
    ...
    {!! Form::open(['url' => route('person.purchase_requirements.store'),'enctype' => 'multipart/form-data']) !!}
    ...
    <div class="overflow-hidden sm:rounded-md md:w-10/12 w-11/12 mx-auto py-20 relative">
        <div class="px-8 md:px-8 py-6  md:w-4/5 w-full mx-auto rounded-lg shadow-md bg-purple-800 bg-opacity-70 mt-10">
            <h1 class="text-2xl m-0 text-white mb-8 font-bold flex flex-col">
                {{ __('Request For Meeting (RFM) ') }}
                <p class="font-normal text-base text-gray-200 mt-1">Submit your product or service requirement and get the correct contacts line up to meet you.</p>
            </h1>
            <div class="grid grid-cols-6 md:gap-4 md:gap-x-6 gap-y-4 auto-cols-frw-full">
                ...
                <div class="col-span-6 md:col-span-3">
                    ...
                    {!! Form::text('product', old('product'), ['class' => 'mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-md md:text-sm text-base border-0 border-gray-300 rounded-md']); !!}
                ...
                <div class="col-span-6 md:col-span-3">
                    ...
                    {!! Form::textarea('description', old('description'), ['class' => 'mt-1 h-16 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-md md:text-sm text-base border-0 border-gray-300 rounded-md']); !!}
                ...
                <div class="col-span-6 md:col-span-3">
                    ...
                    {!! Form::number('quantity', old('quantity'), ['step' => '0.01', 'class' => 'mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full border-0 shadow-md md:text-sm text-base border-gray-300 rounded-md']); !!}
                ...
                <div class="col-span-6 md:col-span-3">
                    ...
                    {!! Form::select('metric_id', $metrics, old('metric_id'), ['placeholder' => 'Pick a Category','class' => 'select2 mt-1 block w-full py-2 px-3 border-0 border-gray-300 bg-white rounded-md shadow-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 md:text-sm text-base']) !!}
                ...
                <div class="col-span-6 md:col-span-3">
                    ...
                    {!! Form::number('price', old('price'), ['step' => '0.01', 'class' => 'mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full border-0 shadow-md md:text-sm text-base border-gray-300 rounded-md']); !!}
                ...
                <div class="col-span-6">
                    ...
                    <div class="mt-1 flex rounded-md shadow-md">
                        {!! Form::url('url', old('url'), ['class' => 'focus:ring-indigo-500 focus:border-indigo-500 border-0 flex-1 block w-full rounded-md md:text-sm text-base border-gray-300']); !!}
                    </div>
                ...
                <div class="col-span-6 md:col-span-3">
                    ...
                    {!! Form::textarea('pre_meeting_sample', old('pre_meeting_sample'), ['class' => 'mt-1 h-16 focus:ring-indigo-500 focus:border-indigo-500 border-0 block w-full shadow-md md:text-sm text-base border-gray-300 rounded-md']); !!}
                ...
                <div class="col-span-6 md:col-span-3">
                    ...
                    {!! Form::textarea('certification_requirement', old('certification_requirement'), ['class' => 'mt-1 h-16 focus:ring-indigo-500 focus:border-indigo-500 block border-0 w-full shadow-md md:text-sm text-base border-gray-300 rounded-md']); !!}
                ...
                <div class="col-span-6 md:col-span-3">
                    ...
                    {!! Form::date('target_purchase_date', old('target_purchase_date'), ['class' => 'mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full border-0 shadow-md md:text-sm text-base border-gray-300 rounded-md']); !!}
                ...
                <div class="col-span-6 md:col-span-3">
                    ...
                    {!! Form::select('purchase_frequency', $purchaseFrequencies, old('purchase_frequency'), ['placeholder' => 'Pick a Frequency','class' => 'select2 mt-1 block w-full py-2 px-3 border-0 border-gray-300 bg-white rounded-md shadow-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 md:text-sm text-base']) !!}
                ...
                <div class="col-span-6 md:col-span-3">
                    ...
                    {!! Form::select('purchase_policy', $purchasePolicies, old('purchase_policy'), ['placeholder' => 'Pick a Policy','class' => 'select2 mt-1 block w-full py-2 px-3 border-0 border-gray-300 bg-white rounded-md shadow-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 md:text-sm text-base']) !!}
                ...
                <div class="col-span-6 md:col-span-3">
                    ...
                    {!! Form::text('warranties_requirement', old('warranties_requirement'), ['class' => 'mt-1 focus:ring-indigo-500 focus:border-indigo-500 border-0 block w-full shadow-md md:text-sm text-base border-gray-300 rounded-md']); !!}
                ...
                <div class="col-span-6 md:col-span-3">
                    ...
                    {!! Form::text('safety_standard', old('safety_standard'), ['class' => 'mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full border-0 shadow-md md:text-sm text-base border-gray-300 rounded-md']); !!}
                ...
                <div class="col-span-6 md:col-span-3">
                    ...
                    {!! Form::select('hs_code[]', $hs_codes, old('hs_code[]'), ['multiple'=> 'multiple', 'class' => 'select2 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full border-0 shadow-md md:text-sm text-base border-gray-300 rounded-md']); !!}
                    @error('hs_code')
                    <div class="text-xs text-red-600 text-left mt-1">{{ $message }}</div> @enderror
                </div>
                <div class="col-start-1 col-span-6"><hr></div>
                <div class="col-span-6 md:col-span-3">
                    ...
                    @error('images') <div class="text-xs text-red-600 text-left mt-1">{{ $message }}</div> @enderror
                    @error('images.*') <div class="text-xs text-red-600 text-left mt-1">{{ $message }}</div> @enderror
                </div>
                <div class="col-span-6 md:col-span-3">
                    ...
                    @error('requirement_specification') <div class="text-xs text-red-600 text-left mt-1">{{ $message }}</div> @enderror
                </div>
                <div class="col-start-1 col-span-6"><hr></div>
                <div @tags-update="console.log('tags updated', $event.detail.tags)" data-tags='[]' class="col-span-6" >
            ...
            <div class="pt-8 text-left">
                <a href="{{route('person.purchase_requirements.index')}}" class="inline-flex ml-2 justify-center py-2 px-6 shadow-md text-sm font-medium rounded-md text-gray-900 bg-gray-200 hover:bg-gray-400 focus:outline-none focus:ring-0 cursor-pointer">
                    Back
                </a>
