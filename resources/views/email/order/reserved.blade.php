                ...
                <tr>
                    <td class="content-cell" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; padding: 45px;">
                        <div class="f-fallback">
                            ...
                            <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">Your order and meeting time has been reserved successfully, please make sure to attend the reserved appointment slot in time!</p>
                            @if($order->items[0]->meeting->user)
                            <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">Your Search meetings host for this meeting is {{$order->items[0]->meeting->user->name}}</p>
                            @endif
                            <p style="font-size: 1em; font-weight: 400;margin-top: 5px;">
                                <em>Frequent missed meetings or cancellations without notice will result in your account being suspended</em>
                            </p>
                            <!-- Action -->
