                ...
                <tr>
                    <td class="content-cell" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; padding: 45px;">
                        <div class="f-fallback">
                            ...
                            <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">Thank you for your interest in <b>{{$meeting_request->purchase_requirement->product}}</b>, An agent will find a suitable time for a meeting
                            based on your preferred availability and contact you as soon as possible.</p>
                            <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">In the meantime, you can browse through thousands of other purchase requirements by clicking on the search button below.</p>
                            <!-- Action -->
