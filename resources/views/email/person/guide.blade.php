                ...
                <tr>
                    <td class="content-cell" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; padding: 45px;">
                        <div class="f-fallback">
                            ...
                            <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">Start Meeting business contacts, Online suppliers, Customers, Partners, Professionals and more. Your new secret weapon of success.</p>
                            <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">Now you can start with just a few steps:</p>
                            <ol style="font-size: 16px; line-height: 1.625; margin: .4em 0 1.1875em;">
                                <li>Search among thousands of meeting requests with purchase requirements or submit your Request for Meeting RFM</li>
                                <li>One of our professional meetings agents will contact you and discuss the requirement and confirm your availability</li>
                                <li>Pick who you want to meet and reserve an available time slot</li>
                                <li>Turn up on time, meet the prospect and pay only for successful meetings after meeting starts</li>
                                <li>Ensure best business outcomes, necessary post meeting follow ups by our consultants</li>
                            </ol>
                            <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">To get started, Login to your dashboard: </p>
                            <!-- Action -->
                                ...
                                <tr>
                                    <td align="center" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px;">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                            <tr>
                                                <td align="center" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px;">
                                                    <a href="{{$route}}" class="f-fallback button button--black" target="_blank">Login</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
