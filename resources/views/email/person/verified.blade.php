                ...
                <tr>
                    <td class="content-cell" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; padding: 45px;">
                        <div class="f-fallback">
                            ...
                            <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">Your account is now verified!</p>
                            <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">This grants you full access to all the features of our service.</p>
                            <ol style="font-size: 16px; line-height: 1.625; margin: .4em 0 1.1875em;">
                                <li>Create and publish new purchase requirements</li>
                                <li>Schedule meetings with suppliers around the world</li>
                                <li>Profile, match and identify key contacts match your requirement</li>
                                <li>Browse through thousands of published purchase requirements and generate leads for your business</li>
                            </ol>
