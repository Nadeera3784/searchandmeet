...
@section('content')
    ...
    <div x-data="availabilityConfigurator()" x-init="init()" class="flex bg px-4 h-full pt-20 min-h-screen relative">
    ...
    <script>
        function availabilityConfigurator() {
            return {
                ...
                warningText: '',
                modalVisible: false,
                default_availability: {!! auth('person')->user()->schedule->default_availability !!},
                day_from: undefined,
                day_to: undefined,
                ...
                days: {!! auth('person')->user()->schedule->day_availability !!},
                selected_day: undefined,
                custom_timeslot_array: {!! auth('person')->user()->schedule->custom_availability !!},
                ...
                saveAvailability() {
                    ...
                    const url = '{{route('person.schedule.update')}}';
                    const data = {
                        person_id: {{auth()->guard('person')->user()->id}},
