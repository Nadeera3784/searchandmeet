    ...
    <head>
        ...
        <style type="text/css" rel="stylesheet" media="all">
            ...
            .button--black {
                ...
                border-right: 18px solid #080808;
                border-bottom: 10px solid #080808;
                border-left: 18px solid #080808;
            }
                    ...
                    <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation" style="width: 100%; -premailer-width: 100%; -premailer-cellpadding: 0; -premailer-cellspacing: 0; margin: 0; padding: 0;">
                        <tr>
                            <td class="email-masthead" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; text-align: center; padding: 25px 0;" align="center">
                                <a href="{{config('app.url')}}" class="f-fallback email-masthead_name" style="color: #A8AAAF; font-size: 16px; font-weight: bold; text-decoration: none; text-shadow: 0 1px 0 white;">
                                    <img src="{{asset('/img/Search-Meetings-Logo.png')}}" alt="Logo" style="height: 3rem;">
                                </a>
                            </td>
                        </tr>
                        @yield('content')
                                    ...
                                    <tr>
                                        <td class="content-cell" align="center" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; padding: 45px;">
                                            <p class="f-fallback sub align-center" style="font-size: 13px; line-height: 1.625; text-align: center; color: #A8AAAF; margin: .4em 0 1.1875em;" align="center">
                                                Search Meetings Inc.
                                                <br />1001 Wilshire Boulevard #1018
                                                <br />Los Angeles
                                                <br />CA 90017
                                                <br />Phone: <a href="tel://+12132677303">+1 213 267 7303</a>
                                                <br />Email: <a href="mailto://info@searchmeetings.com">info@searchmeetings.com</a>
                                            </p>
                                            <p class="f-fallback sub align-center" style="font-size: 13px; line-height: 1.625; text-align: center; color: #A8AAAF; margin: .4em 0 1.1875em;" align="center">Copyright © Search Meetings Inc. All rights reserved</p>
                                        </td>
                                    </tr>
                                </table>
                            </td>
